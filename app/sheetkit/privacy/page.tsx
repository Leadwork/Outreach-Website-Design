...
export const metadata: Metadata = {
  ...
  description: "How SheetKit processes spreadsheet data, permissions, temporary previews and support requests.",
  alternates: { canonical: 'https://www.proleadmaker.com/sheetkit/privacy' },
  openGraph: { title: "SheetKit Privacy Policy | ProLeadMaker Tools", description: "How SheetKit processes spreadsheet data, permissions, temporary previews and support requests.", url: 'https://www.proleadmaker.com/sheetkit/privacy', type: 'website' },
  twitter: { card: 'summary', title: "SheetKit Privacy Policy | ProLeadMaker Tools", description: "How SheetKit processes spreadsheet data, permissions, temporary previews and support requests." }
};
...
export default function PrivacyPage() {
  return <article className="prose-blog mx-auto max-w-3xl py-14">
    ...
    <p>Last updated: September 11, 2026. Publisher: ProLeadMaker Tools. This policy covers SheetKit - Remove Duplicates, Merge, Change Case and its support pages.</p>
    ...
    <p>The add-on runs on Google Apps Script. Its code does not transmit spreadsheet contents to ProLeadMaker Tools, this website, an external API, advertising services or analytics services. We do not sell spreadsheet data or use it for advertising or AI model training.</p>
    <h2>Permissions</h2>
    ...
    <p>SheetKit’s use and transfer of information received from Google APIs will adhere to the <a href="https://developers.google.com/terms/api-services-user-data-policy">Google API Services User Data Policy</a>, including the Limited Use requirements.</p>
